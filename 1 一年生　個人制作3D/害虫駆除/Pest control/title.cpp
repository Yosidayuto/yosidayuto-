...
{
	{ "data/image/TitleBackground.png" },
	{ "data/image/StartButton.png" },
	{ "data/image/ShutDownButton.png" },
	{ "data/image/TitleLogo.png" },
};
...
void UpdateTitle(void)
{
	...
	/*位置設定*/
	g_Title[1].pos = D3DXVECTOR3(640.0f, 540.0f, 0.0f);
	...
	/*位置設定*/
	g_Title[2].pos = D3DXVECTOR3(640.0f, 660.0f, 0.0f);
