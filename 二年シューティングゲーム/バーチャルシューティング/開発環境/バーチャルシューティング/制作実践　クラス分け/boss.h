...
public:
	...
	static bool GetEnemyNumber(void) { return m_bDie; };
private:
	...
	static char					*pTexture[BOSS_TYPE_MAX];	//テキスト名
	static LPDIRECT3DTEXTURE9	m_Texture[BOSS_TYPE_MAX];	//テクスチャのポインタ
