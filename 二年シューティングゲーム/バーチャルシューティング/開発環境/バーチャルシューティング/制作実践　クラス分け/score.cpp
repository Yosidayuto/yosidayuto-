...
//静的メンバー変数
//----------------------------------------------
//LPDIRECT3DTEXTURE9 CScore::m_apTexture = NULL;
...
HRESULT CScore::Init()
{
	...
	{
		m_apUi = CUi::Create
		(D3DXVECTOR3(m_pos.x + (m_size.x*MAX_SCORE / 2), m_pos.y + (m_size.y / 2), 0.0f),
			D3DXVECTOR3(m_size.x*(MAX_SCORE*1.5), m_size.y*1.5, 0.0f),
