...
// マクロ定義
//*****************************
#define BMP_TEX_PATH     "./Data/Texture/sea/BMP_water4.png"   // バンプマップテクスチャのパス
#define BMP_TEX_PATH2    "./Data/Texture/sea/BMP_water4.png"   // バンプマップテクスチャのパス
#define CUBE_TEX_PATH    "./Data/Texture/sea/cube_sky.dds"   // キューブテクスチャのパス
...
// コンストラクタ
//******************************
CSea::CSea() :CObject3dShader(PRIORITY_OBJECT_SEA)
{
	m_fWaveaRate = 0.0f;
	m_fWaveSpeed = 0.0f;
