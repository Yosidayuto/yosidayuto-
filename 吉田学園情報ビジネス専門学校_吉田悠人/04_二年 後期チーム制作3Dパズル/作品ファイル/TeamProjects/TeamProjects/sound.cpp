...
CSound::PARAM CSound::m_aParam[SOUND_LABEL_MAX] =
{
	...
	{ "Data/Sound/BGM/Stage1.wav", -1 },		//ステージ１BGM
	{ "Data/Sound/BGM/Stage2.wav", -1 },		//ステージ２BGM
	{ "Data/Sound/BGM/Stage3.wav", -1 },		//ステージ３BGM
	{ "Data/Sound/SE/Decision.wav", 0 },		//決定音
	{ "Data/Sound/SE/Message.wav", 0 },			//セリフが出るとき
	{ "Data/Sound/SE/Tutorial.wav", 0 },		//チュートリアルが出るとき
	{ "Data/Sound/SE/Reached.wav", 0 },			//オブジェクトが指定の位置に置かれたとき
	{ "Data/Sound/SE/Show_Pose.wav", 0 },		//ポーズ表示音
	{ "Data/Sound/SE/Choice.wav", 0 },			//ポーズ選択音
	{ "Data/Sound/SE/Error.wav", 0 },			//エラー音
}; 
//=============================================================================
// コンストラクタ
//=============================================================================
